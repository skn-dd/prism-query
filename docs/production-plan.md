...
Wave status, pending-items ranking, and the next parallel slice live in [`wave-status.md`](wave-status.md). This doc stays strategic: phases, principles, design decisions.
