...
public class PrismPageSource implements ConnectorPageSource {
    ...
    public PrismPageSource(
        ...
        this(executor, split, tableHandle, columns, null);
    }
    ...
    public PrismPageSource(
        ...
        if (queryStats != null) {
            // A PrismPageSource was created => pushdown was accepted and a
            // worker invocation will happen. Flag acceleration early so that
            // even if the query fails later we still record it touched Prism.
